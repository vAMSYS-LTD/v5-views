                ...
                <div class="card overflow-hidden shadow-lg min-w-96">
                    <div class="p-9">
                        <div class="text-center mx-auto w-3/4">
                            <h4 class="text-dark/70 text-center text-lg font-bold dark:text-light/80 mb-2">Password Reset</h4>
                        </div>
                        <form class="space-y-5 dark:text-white" action="{{ route('password.update') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-6 space-y-2">
                                <label for="password" class="font-semibold text-gray-500">New Password</label>
                                <input class="form-input" type="password" id="password" name="password" required="" placeholder="Enter your new Password">
                            </div>

                            <div class="mb-6 space-y-2">
                                <label for="password_confirmation" class="font-semibold text-gray-500">Confirm New Password</label>
                                <input class="form-input" type="password" id="password_confirmation" name="password_confirmation" required="" placeholder="Confirm your new Password">
                            </div>
