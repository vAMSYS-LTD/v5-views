                ...
                <div class="card overflow-hidden shadow-lg">
                    <div class="p-9">
                        <div class="text-center mx-auto w-3/4">
                            <h4 class="text-dark/70 text-center text-lg font-bold dark:text-light/80 mb-2">Confirm 2FA</h4>
                            <p class="text-gray-400 mb-9">Please enter your 2FA or Backup Code</p>
                        </div>
                        <form class="space-y-5 dark:text-white" action="{{ route('two-factor.login') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-6 space-y-2">
                                <div class="flex items-center">
                                    <input type="text" name="code" id="code" class="form-input rounded-e-none" placeholder="Enter your 2FA Code">
                                </div>
                            </div>
