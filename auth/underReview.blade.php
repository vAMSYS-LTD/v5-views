            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 py-10">
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">Under Review</h1>
                            <p class="text-base font-bold leading-normal dark:text-white">{{ $message }}</p>
                        </div>
                    </div>
                </div>
            </div>
