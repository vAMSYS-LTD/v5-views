    ...
    <div class="large-alert alert-danger">
        <div class="text-center pb-0 flex flex-col sm:flex-row ">
            <div class="mb-4 sm:mb-0 flex justify-center items-center">
                <svg class="large-alert-icon fill-danger inline-flex" xmlns="http://www.w3.org/2000/svg" height="1.5rem"
            ...
            <div class="my-auto grow">
                <p>
                    You may <strong>only</strong> invite Pilots to your Virtual Airline <strong>if you have their
                        permission</strong>.<br />
                    If we cannot find a registered vAMSYS user with these details - a new account will be created for
                    them. <br />
