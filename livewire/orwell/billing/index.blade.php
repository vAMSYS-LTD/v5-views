    ...
    <div class="grid gap-6 grid-cols-3">
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">Why a recurring subscription?</h4>
            </div>
        ...
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">How and when will I be charged?</h4>
            </div>
            <div class="px-6 py-2 space-y-2">
        ...
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">Can I cancel?</h4>
            </div>
            <div class="px-6 py-2 space-y-2">
        ...
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">Are my card details safe?</h4>
            </div>
            <div class="px-6 py-2 space-y-2">
                Absolutely. <br/>
        ...
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">Can I change my plan from monthly to yearly?</h4>
            </div>
            <div class="px-6 py-2 space-y-2">
        ...
        <div class="card h-full">
            <div class="card-header flex justify-between items-center">
                <h4 class="card-title">What payment methods are accepted?</h4>
            </div>
            <div class="px-6 py-2 space-y-2">
