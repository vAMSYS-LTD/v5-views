                    ...
                    <form class="space-y-5 dark:text-white" action="{{ route('login') }}" method="POST">
                        ...
                        <div>
                            <div class="relative text-white-dark">
                                <input id="Email" type="email" required name="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" />
                        ...
                        <div>
                            <div class="relative text-white-dark">
                                <input id="Password" type="password" required name="password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" />
                                <span class="absolute top-1/2 -translate-y-1/2 start-4">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
