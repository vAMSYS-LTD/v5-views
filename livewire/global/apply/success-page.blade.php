...
<div class="flex flex-col space-y-4">
    <div class="card">
        ...
        <div class="px-6 py-4 space-y-2">
            ...
            <div>
                We are not 100% finished with the onboarding documentation for new Virtual Airlines and <strong>your Application is on hold</strong>.
            </div>
            <div class="mt-4 text-lg">
                On, or before 4th October, you will receive an email notification when your Virtual Airline has been created and trial period has begun.
            </div>
        </div>
    </div>
...
{{--            </div>--}}
{{--            <div class="mt-8">--}}
{{--                <a href="https://docs.vamsys.dev" target="_blank" class="btn btn-lg w-full bg-success text-white">--}}
{{--                    Once logged in and in your VA, click here to see the New VA Checklist which will guide you through 3+ day process of setting up your new Virtual Airline--}}
{{--                </a>--}}
{{--            </div>--}}
