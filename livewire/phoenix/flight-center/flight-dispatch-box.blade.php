    ...
    @if($route)
        ...
        <form id="sbapiform">
            ...
            <input type="hidden" name="date"
                   value="{{ strtoupper(Carbon::parse($data['departureTime'])->format('dMy')) }}">
            <input type="hidden" name="deph" value="{{ Carbon::parse($data['departureTime'])->format('G') }}">
            <input type="hidden" name="depm" value="{{ Carbon::parse($data['departureTime'])->format('i') }}">
            ...
            <input type="hidden" name="steh" value="{{ Carbon::parse($this->route->flight_length)->format('G') }}">
            <input type="hidden" name="stem" value="{{ Carbon::parse($this->route->flight_length)->format('i') }}">
